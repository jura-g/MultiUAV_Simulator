...
class JointTrajectoryToMultiDofTrajectoryPoint:
    ...
    def __init__(self):
        ...
        self.uav_trajectory_point_pub = rospy.Publisher('/red/position_hold/trajectory', 
            MultiDOFJointTrajectoryPoint, queue_size=1)
        self.executing_trajectory_pub = rospy.Publisher('/red/position_hold/executing_trajectory', 
            Int32, queue_size=1)

        rospy.Subscriber('/building_envelope/joint_trajectory', JointTrajectory, 
